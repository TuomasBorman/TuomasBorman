...
|:----------------:|:----------------:|:----------------:|:----------------:|:----------------:|:----------------:|:----------------:|
| [_anansi_](https://thomazbastiaanssen.github.io/anansi/) | Package | Contributor | GitHub | [GitHub](https://github.com/thomazbastiaanssen/anansi) | [![](https://bioconductor.org/shields/build/release/bioc/anansi.svg)](http://bioconductor.org/checkResults/release/bioc-LATEST/anansi) | [![](https://bioconductor.org/shields/build/devel/bioc/anansi.svg)](http://bioconductor.org/checkResults/devel/bioc-LATEST/anansi) |
...
| [_mikropml_](https://www.schlosslab.org/mikropml/) | Package | Contributor | CRAN | [GitHub](https://github.com/SchlossLab/mikropml) | | |
...
| [_OMA_](https://bioconductor.org/books/release/OMA/) | Book | Maintainer | Bioconductor | [GitHub](https://github.com/microbiome/OMA) | | |
